...
namespace Lab2_ImageService.Services
{
    public class ComputerVisionService : IComputerVisionService
    {
        ...
        public void DrawBoundingBoxes(ImageAnalysis analysis, string imageFile)
        {
            ...
            string outputFileName = Path.GetFileNameWithoutExtension(imageFile) + "_object_face.jpg";
